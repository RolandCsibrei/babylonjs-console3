...
var console3 = /** @class */ (function () {
    ...
    console3.prototype._createConsolePanel = function () {
        if (this._gui) {
            ...
            scrollViewer.verticalAlignment =
                BABYLON.GUI.StackPanel.VERTICAL_ALIGNMENT_BOTTOM;
            scrollViewer.forceVerticalBar = true;
            var consolePanel = new BABYLON.GUI.StackPanel();
    ...
    console3.prototype._createMainPanel = function () {
        var _a;
        this._mainPanel = new BABYLON.GUI.StackPanel("console3-main-panel");
        this._mainPanel.horizontalAlignment =
            BABYLON.GUI.StackPanel.HORIZONTAL_ALIGNMENT_RIGHT;
        this._mainPanel.verticalAlignment =
            BABYLON.GUI.StackPanel.VERTICAL_ALIGNMENT_TOP;
    ...
    console3.prototype._createButtons = function () {
        var buttonPanel = new BABYLON.GUI.StackPanel("console3-button-panel");
    ...
    console3.prototype._createInspectorButton = function (parent) {
        var _this = this;
        var btn = BABYLON.GUI.Button.CreateSimpleButton("console3-button-inspector-toggle", "D");
        ...
        btn.horizontalAlignment = BABYLON.GUI.Button.HORIZONTAL_ALIGNMENT_RIGHT;
    ...
    console3.prototype._createConsoleLinesToggleButton = function (parent) {
        var _this = this;
        var btn = BABYLON.GUI.Button.CreateSimpleButton("console3-buttton-console-lines-toggle", "C");
        btn.widthInPixels = 28;
        btn.heightInPixels = 24;
        btn.color = "white";
        btn.fontSize = 12;
    ...
    console3.prototype._createConsoleToggleButton = function (parent) {
        var _this = this;
        var btn = BABYLON.GUI.Button.CreateSimpleButton("console3-button-console-toggle", "O");
        btn.widthInPixels = 28;
        btn.heightInPixels = 24;
        btn.color = "white";
        btn.fontSize = 12;
    ...
    console3.prototype._createSideToggleButton = function (parent) {
        var _this = this;
        var btn = BABYLON.GUI.Button.CreateSimpleButton("console3-button-side-toggle", ">");
        btn.widthInPixels = 28;
        btn.heightInPixels = 24;
        btn.color = "white";
        btn.fontSize = 12;
        ...
        btn.onPointerUpObservable.add(function () {
            ...
            if (_this._side === Side.Left) {
                ...
                btn.rotation = 0;
                btn.horizontalAlignment = BABYLON.GUI.Button.HORIZONTAL_ALIGNMENT_LEFT;
                _this._mainPanel.horizontalAlignment =
                    BABYLON.GUI.StackPanel.HORIZONTAL_ALIGNMENT_LEFT;
                _this._buttonPanel.horizontalAlignment =
                    BABYLON.GUI.StackPanel.HORIZONTAL_ALIGNMENT_LEFT;
            }
    ...
    console3.prototype._addObserverFrame = function (entity, inputCount) {
        ...
        if (this._gui) {
            var parentPanel = new BABYLON.GUI.StackPanel();
            ...
            if (entity.options.linkedWithMesh === true) {
                ...
                var line = new BABYLON.GUI.Line("line-" + entity.name);
                line.lineWidth = 2;
                line.dash = [3, 3];
                line.color = "white";
                line.y2 = 20;
            ...
            var textLabel = new BABYLON.GUI.TextBlock();
            ...
            for (var i = 0; i < inputCount; i++) {
                ...
                textValue.horizontalAlignment =
                    BABYLON.GUI.TextBlock.HORIZONTAL_ALIGNMENT_CENTER;
